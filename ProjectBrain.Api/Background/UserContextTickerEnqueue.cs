...
public static class UserContextTickerEnqueue
{
    ...
    public const string MemoryExtraction = "UserContext_MemoryExtraction";
    ...
    public static async Task EnqueueConversationTitleSummaryAsync(
        ITimeTickerManager<TimeTickerEntity> manager,
        string userId,
        Guid conversationId,
        ...
        CancellationToken ct = default)
    {
        await manager.AddAsync(new TimeTickerEntity
        {
            Function = ConversationTitleSummary,
            ExecutionTime = DateTime.UtcNow,
            Request = TickerHelper.CreateTickerRequest(new ConversationTitleSummaryRequest
            {
                UserId = userId,
    ...
    public static async Task EnqueueMemoryExtractionAsync(
        ITimeTickerManager<TimeTickerEntity> manager,
        string userId,
        Guid conversationId,
        string userContent,
        ...
        CancellationToken ct = default)
    {
        await manager.AddAsync(new TimeTickerEntity
        {
            Function = MemoryExtraction,
            ExecutionTime = DateTime.UtcNow,
            Request = TickerHelper.CreateTickerRequest(new MemoryExtractionRequest
            {
                UserId = userId,
                ConversationId = conversationId,

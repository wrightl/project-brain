...
import { CoachOnboardingData } from '@/types/user';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          This helps us connect you with users in your geographical region
        </p>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-gray-500">
          Share your background, relevant certifications, and experience working with neurodivergent individuals
        </p>
      </div>

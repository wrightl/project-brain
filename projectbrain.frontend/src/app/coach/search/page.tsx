      ...
      <div className="space-y-6">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-sm">
              Enter search criteria and click &quot;Search Users&quot; to find users in your area
            </p>
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
            <li>Search results are filtered based on geographical proximity</li>
            <li>User contact information is protected and only shared with mutual consent</li>
            <li>Users must opt-in to be discoverable by coaches</li>
            <li>API endpoint for user search needs to be implemented</li>
          </ul>
        </div>
      </div>
    </RoleGuard>

...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoachSpecialismOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CoachSpecialismOptions");
                });

            modelBuilder.Entity("CommunityChannel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CommunityReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CommunityReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MemoryPromotionAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MemoryPromotionAudits");
                });
            ...
            modelBuilder.Entity("UserEpisode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RelatedStrategyId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CommunityPost", b =>
                {
                    ...
                    b.HasOne("CommunityChannel", "Channel")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("UserEpisode", b =>
                {
                    b.HasOne("UserCopingStrategy", "RelatedStrategy")
                        .WithMany()
                        .HasForeignKey("RelatedStrategyId")
                        .OnDelete(DeleteBehavior.NoAction);

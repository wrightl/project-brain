...
export default function UserOnboardingForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <label htmlFor="preferredPronoun" className="block text-sm font-medium text-gray-700">
          Preferred Pronouns *
        </label>
        <select
          id="preferredPronoun"
      ...
      <div>
        <label htmlFor="neurodivergentDetails" className="block text-sm font-medium text-gray-700">
        ...
        <p className="mt-1 text-xs text-gray-500">
          This information helps us provide better support. It&apos;s completely optional and will be kept confidential.
        </p>
      </div>

...
export default function PageHeader() {
    ...
    return (
        <header className="fixed w-full">
            <nav
                aria-label="Global"
                className="bg-white border-gray-200 dark:bg-gray-900 flex items-center justify-between p-6 lg:px-8"
            >
                            ...
                            <div className="space-y-2 py-6">
                                {navigation.map((item) => (
                                    <a
                                        key={item.name}
                                        href={item.href}
                                        className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50 dark:hover:text-gray-900 dark:text-white"
                                    >
                                        {item.name}
                                    </a>
                                ))}
